...
public class Character {
    ...
    public Character(String id, String name, int maxHp, int maxMp, int attackPower, 
        ...
        ValidationUtil.requireNonNull(id, "Character ID cannot be null");
        ValidationUtil.requireNonNull(name, "Character name cannot be null");
        ValidationUtil.requirePositive(maxHp, "Max HP must be positive");
        ValidationUtil.requirePositive(maxMp, "Max MP must be positive");
