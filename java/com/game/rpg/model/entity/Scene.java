...
public class Scene {
    ...
    public Scene(String id, String name, String backgroundPath) {
        ValidationUtil.requireNonNull(id, "Scene ID cannot be null");
        ValidationUtil.requireNonNull(name, "Scene name cannot be null");
    ...
    public void addInteractableObject(InteractableObject object) {
        ValidationUtil.requireNonNull(object, "Interactable object cannot be null");
        interactableObjects.add(object);
    }
    
    public void addNPC(NPC npc) {
        ValidationUtil.requireNonNull(npc, "NPC cannot be null");
        npcs.add(npc);
    }
    
    public void addTriggerZone(String zoneId, double[] bounds) {
        ValidationUtil.requireNonNull(zoneId, "Zone ID cannot be null");
        ValidationUtil.requireNonNull(bounds, "Bounds cannot be null");
        if (bounds.length != 4) {
