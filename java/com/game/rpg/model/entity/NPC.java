...
public class NPC {
    ...
    public NPC(String id, String name, String portraitPath, double x, double y) {
        ValidationUtil.requireNonNull(id, "NPC ID cannot be null");
        ValidationUtil.requireNonNull(name, "NPC name cannot be null");
    ...
    public void addDialogue(String dialogue) {
        ValidationUtil.requireNonNull(dialogue, "Dialogue cannot be null");
